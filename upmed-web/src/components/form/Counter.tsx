...
export const Counter = (props: CounterProps) => {
    const initialValue = !Objects.isNullish(props.value) ? props.value! : !Objects.isNullish(props.min) ? props.min! : !Objects.isNullish(props.max) ? props.max! : 0
    ...
    return (
        ...
        >
            ...
            <div
                className={styles.counter_inner}
            >
                <Button
                    text={'–'}

...
export const EditProfile = (props: ProfileSubpageProps) => {
	...
	useEffect(() => {
		...
		setIsValid(
			!Objects.isNullish(firstName) && firstName.length > 0 && Validator.realName(firstName) &&
			!Objects.isNullish(lastName) && lastName.length > 0 && Validator.realName(lastName) &&
			!Objects.isNullish(email) && email.length > 0 && Validator.email(email) &&
			!Objects.isNullish(phone) && phone.length > 0 && Validator.phone(phone) &&
	...
	}, [firstName, lastName, email, specialty, title, phone, dateOfBirth, weight, height, drinker, smoker, hours, hoursValid, props.isPatient])
                ...
                <div className={''}>
                    ...
                    <div className={'d-flex flex-column-reverse justify-content-between mt-4'}>
                        <div className={'d-flex flex-row justify-content-end align-items-center'}>
                            {
                                loadingUpdate &&
                                <Loading size={'50px'} className={'w-25 mr-4'} />
                            }
                            <div>
                                <Button
